...
var myVersion = '0.0.13'; // should match package.json
...
var symbolication_maps;

function setSymbolicationMap(array) {
  if(!array)
    throw new Error('Symbolication Map is undefined');
  if(!Array.isArray(array))
    throw new Error('Symbolication Map is not an instance of Array');
...
function BacktraceReport() {
  ...
  } else if (symbolication_maps) {
    this.report.symbolication = 'sourcemap';
    this.report.symbolication_maps = symbolication_maps;
  }
  this.logLines = [];
}
...
BacktraceReport.prototype.setSymbolicationMap = function(array) {
  if(!array)
    throw new Error('Symbolication Map is undefined');
  if(!Array.isArray(array))
    throw new Error('Symbolication Map is not an instance of Array');
  this.report.symbolication_maps = array;
  this.report.symbolication = 'sourcemap';
};
